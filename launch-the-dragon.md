...
description: Orient any Grok instance to the Train Your Dragon system and the user’s private core. Loads key intentions, pointers to My-Dragon-AI, and standing rules so the session starts aligned. Triggers on launch the dragon, boot dragon, orient me, load train your dragon, or similar.
---
...
When a session starts cold (new instance, voice mode, limited context), this skill brings the AI into alignment with:
...
2. Present the current orientation block.
3. Offer to pull latest pointers from My-Dragon-AI if needed.
4. Confirm the session is now aligned and ready.

## Relationship

This skill is the practical answer to cross-instance continuity.  
Memory does the everyday work when available; Launch the Dragon covers cold starts.
