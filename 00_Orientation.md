# 00_Orientation.md
**Project:** Train Your Dragon (Public / Developed Method)  
...
The developed, public expression of the Train Your Dragon method.  
It teaches the PARA-MOC architecture so others can implement a durable, consent-based personal AI system.

Living personal work does **not** live in this repository.  
Living work stays in the user’s own storage (PARA).

## Key files

| File | Purpose |
|------|---------|
| README.md | Overview, credits, quick start |
| ORIGIN.md | Discovery, agency, philosophy |
...
## Status
Previous project splits (separate nosce-te-ipsum, shared-dragon, my-dragon tracks, etc.) are retired.  
This repository now represents the single public method under the PARA-MOC architecture.
